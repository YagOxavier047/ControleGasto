...
// Rota da API: Listar Movimentações (NOME CORRETO!)
...
// Rota da API: Adicionar Movimentação (NOME CORRETO!)
...
// Rota da API: Deletar Movimentação (NOME CORRETO!)
...
console.log(`🚀 WebSocket rodando em ws://0.0.0.0:${WS_PORT}`);
